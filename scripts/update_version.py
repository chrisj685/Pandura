...
def main():
  ...
  plistpath = scriptpath + "/resources/Pandura-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pandura-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pandura-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pandura-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pandura-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Pandura.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Pandura.iss",inplace=1):
