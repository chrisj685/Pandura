...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Pandura Demo Installer\n"
      else:
        line="OutputBaseFilename=Pandura Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Pandura Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Pandura installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Pandura Demo installer\n"
     else:
       line="SetupWindowTitle=Pandura installer\n"
