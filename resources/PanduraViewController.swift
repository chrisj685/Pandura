/*
  This is the initial ios app extension view controller, which is referenced by Pandura-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class PanduraViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in Pandura-iOS-MainInterface.storyboard to custom class: GenericUI  module: PanduraFramework
